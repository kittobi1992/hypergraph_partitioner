...
# SETUP ENV
###################################
algorithm = "KaFFPa-StrongS-IMap"
kaffpa = os.environ.get("INTEGRATED_MAPPING_KAFFPA_STRONG_SOCIAL")
...
if kaffpa_proc.returncode == 0:
  ...
  for line in out.split('\n'):
    ...
    if "time spent for integrated mapping" in s:
      total_time = float(s.split('time spent for integrated mapping')[1])
  if perform_process_mapping:
