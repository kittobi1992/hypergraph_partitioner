...
export INTEGRATED_MAPPING_KAFFPA_FASTEST="$HOME/kahip_integrated_mapping/deploy/fastestmap"
...
export INTEGRATED_MAPPING_KAFFPA_FASTEST_SOCIAL="$HOME/kahip_integrated_mapping/deploy/ffsocialmap"
